...
class PassengersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post passengers_url, params: { passenger: { id_number: @passenger.id_number, name: @passenger.name, user_id: @passenger.user_id } }
    end
  ...
  test "should update passenger" do
    patch passenger_url(@passenger), params: { passenger: { id_number: @passenger.id_number, name: @passenger.name, user_id: @passenger.user_id } }
