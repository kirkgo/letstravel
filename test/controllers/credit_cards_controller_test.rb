...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { cardholder: @credit_card.cardholder, cvv: @credit_card.cvv, expire_date: @credit_card.expire_date, number: @credit_card.number, user_id: @credit_card.user_id } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { cardholder: @credit_card.cardholder, cvv: @credit_card.cvv, expire_date: @credit_card.expire_date, number: @credit_card.number, user_id: @credit_card.user_id } }
