...
class BusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus" do
    assert_difference('Bus.count') do
      post buses_url, params: { bus: { bus_code: @bus.bus_code, extra_luggage: @bus.extra_luggage, seat_price: @bus.seat_price, seats: @bus.seats } }
    end
  ...
  test "should update bus" do
    patch bus_url(@bus), params: { bus: { bus_code: @bus.bus_code, extra_luggage: @bus.extra_luggage, seat_price: @bus.seat_price, seats: @bus.seats } }
